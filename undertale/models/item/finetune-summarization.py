...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_seq_len", type=int, default=1024, help="max sequence length for captions (will truncate if above)")
    ...
    train_dataset = SummarizerDataset(dataset=split_dataset["train"], prefix_length=args.prefix_length_const, gpt2path=args.gpt2path,
                              ...
                              token_batchsize=args.token_batchsize,max_seq_len=args.max_seq_len)
